 ...
 */
router.get('/tracking', trackingController_1.TrackingController.getAllTracking);
router.post('/tracking', trackingController_1.TrackingController.createTracking);
/**
 * @swagger
 ...
 */
router.get('/tracking/user/:userId', trackingController_1.TrackingController.getTrackingByUser);
/**
 * @swagger
 ...
 */
router.get('/tracking/exercise/:exerciseId', trackingController_1.TrackingController.getTrackingByExercise);
router.put('/tracking/:id', trackingController_1.TrackingController.updateTracking);
router.delete('/tracking/:id', trackingController_1.TrackingController.deleteTracking);
router.put('/tracking/:id/done', trackingController_1.TrackingController.markAsDone);
 ...
 *                   details: []
 */
router.get('/users/:userId/stats', trackingController_1.TrackingController.getUserStats);
